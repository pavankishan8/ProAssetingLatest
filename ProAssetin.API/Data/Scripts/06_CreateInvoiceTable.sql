-- =============================================
-- Script to Create Invoice Table
-- =============================================
-- This script creates the ProAssetinInvoices table in the specified tenant database
-- Usage: Set the USE database statement for your tenant (e.g., ProAsset_Infosys)
-- =============================================

USE [ProAsset_Infosys]  -- Change this to your tenant database
GO
